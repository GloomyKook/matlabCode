...
clear
%%%%%%%%%%%%%%%蓝光3频率，pi相移加合成白
a=imread('G:\511\新建文件夹 (5)\新建文件夹\1.bmp');
a=im2double(a);
a1=imread('G:\511\新建文件夹 (5)\新建文件夹\2.bmp');
a1=im2double(a1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('G:\511\新建文件夹 (5)\新建文件夹\3.bmp');
a=im2double(a);
a1=imread('G:\511\新建文件夹 (5)\新建文件夹\4.bmp');
a1=im2double(a1);
% b=imread('G:\511\新建文件夹 (5)\新建文件夹\7.bmp');
% b=im2double(b);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('G:\511\新建文件夹 (5)\新建文件夹\5.bmp');
a=im2double(a);
a1=imread('G:\511\新建文件夹 (5)\新建文件夹\6.bmp');
a1=im2double(a1);
