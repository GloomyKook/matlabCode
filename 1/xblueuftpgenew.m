...
clear
%%%%%%%%蓝光cuftp，单光栅加合成白
a=imread('G:\925\新建文件夹 (12)\1.bmp');
a=im2double(a);
b=imread('G:\925\新建文件夹 (12)\2.bmp');
b=im2double(b);
b=a+b;
b(b>1)=1;
comp1=0;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('G:\925\新建文件夹 (12)\3.bmp');
a=im2double(a);
b=imread('G:\925\新建文件夹 (12)\4.bmp');
b=im2double(b);
b=a+b;
b(b>1)=1;
b1=b(:,:,bdt);
...
% figure,imshow(mat2gray(uff));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('G:\925\新建文件夹 (12)\5.bmp');
a=im2double(a);
b=imread('G:\925\新建文件夹 (12)\6.bmp');
b=im2double(b);
b=a+b;
b(b>1)=1;
b1=b(:,:,bdt);
