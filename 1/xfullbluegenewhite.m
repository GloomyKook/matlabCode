...
clear
%%%%%%%%%%%%%%%蓝光3频率，pi相移加合成白
a=imread('C:\Users\liu\Desktop\lw2\新建文件夹 (2)\新建文件夹 (9)\1.bmp');
a=im2double(a);
a1=imread('C:\Users\liu\Desktop\lw2\新建文件夹 (2)\新建文件夹 (9)\2.bmp');
a1=im2double(a1);
% b=imread('C:\Users\liu\Desktop\lw2\新建文件夹 (2)\新建文件夹 (9)\7.bmp');
% b=im2double(b);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('C:\Users\liu\Desktop\lw2\新建文件夹 (2)\新建文件夹 (9)\3.bmp');
a=im2double(a);
a1=imread('C:\Users\liu\Desktop\lw2\新建文件夹 (2)\新建文件夹 (9)\4.bmp');
a1=im2double(a1);
% b=imread('C:\Users\liu\Desktop\lw2\新建文件夹 (2)\新建文件夹 (9)\7.bmp');
% b=im2double(b);
...
% figure,imshow(mat2gray(uff));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('C:\Users\liu\Desktop\lw2\新建文件夹 (2)\新建文件夹 (9)\5.bmp');
a=im2double(a);
a1=imread('C:\Users\liu\Desktop\lw2\新建文件夹 (2)\新建文件夹 (9)\6.bmp');
a1=im2double(a1);
