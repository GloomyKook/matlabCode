...
a=im2double(a);
a1=imread('E:\新建文件夹 (13)\新建文件夹 (7)\2.bmp');
a1=im2double(a1);
% b=imread('E:\新建文件夹 (13)\新建文件夹 (7)\7.bmp');
% b=im2double(b);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('E:\新建文件夹 (13)\新建文件夹 (7)\3.bmp');
a=im2double(a);
a1=imread('E:\新建文件夹 (13)\新建文件夹 (7)\4.bmp');
a1=im2double(a1);
% b=imread('E:\新建文件夹 (13)\新建文件夹 (7)\7.bmp');
% b=im2double(b);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('E:\新建文件夹 (13)\新建文件夹 (7)\5.bmp');
a=im2double(a);
a1=imread('E:\新建文件夹 (13)\新建文件夹 (7)\6.bmp');
a1=im2double(a1);
