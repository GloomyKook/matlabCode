...
% clear
%%%%%%%%%%%%%%%蓝光3频率，pi相移加合成白
a=imread('I:\511\新建文件夹 (5)\新建文件夹\1.bmp');
a=im2double(a);
a1=imread('I:\511\新建文件夹 (5)\新建文件夹\2.bmp');
a1=im2double(a1);
% b=imread('I:\511\新建文件夹 (5)\新建文件夹\7.bmp');
% b=im2double(b);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('I:\511\新建文件夹 (5)\新建文件夹\3.bmp');
a=im2double(a);
a1=imread('I:\511\新建文件夹 (5)\新建文件夹\4.bmp');
a1=im2double(a1);
% b=imread('I:\511\新建文件夹 (5)\新建文件夹\7.bmp');
% b=im2double(b);
...
% figure,imshow(mat2gray(uff));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('I:\511\新建文件夹 (5)\新建文件夹\5.bmp');
a=im2double(a);
a1=imread('I:\511\新建文件夹 (5)\新建文件夹\6.bmp');
a1=im2double(a1);
