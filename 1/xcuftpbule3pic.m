...
% clear
%%%%%%%%%%%%%%%蓝光3频率，pi相移加白
a=imread('E:\新建文件夹 (13)\新建文件夹\新建文件夹\1.bmp');
a=im2double(a);
a1=imread('E:\新建文件夹 (13)\新建文件夹\新建文件夹\2.bmp');
a1=im2double(a1);
b=imread('E:\新建文件夹 (13)\新建文件夹\新建文件夹\7.bmp');
b=im2double(b);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('E:\新建文件夹 (13)\新建文件夹\新建文件夹\3.bmp');
a=im2double(a);
a1=imread('E:\新建文件夹 (13)\新建文件夹\新建文件夹\4.bmp');
a1=im2double(a1);
b=imread('E:\新建文件夹 (13)\新建文件夹\新建文件夹\7.bmp');
b=im2double(b);
...
PH2=PH2.*mask0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
a=imread('E:\新建文件夹 (13)\新建文件夹\新建文件夹\5.bmp');
a=im2double(a);
a1=imread('E:\新建文件夹 (13)\新建文件夹\新建文件夹\6.bmp');
a1=im2double(a1);
b=imread('E:\新建文件夹 (13)\新建文件夹\新建文件夹\7.bmp');
b=im2double(b);
